...
<div class="conteudo">
	...
	<form method="post" onSubmit="return validacliente()" name="formCAdastroCliente" action="add.php" enctype="multipart/form-data">
	<table width="50%" align="center">
		...
		<tr>
			<th> Email: </th>
			<td ><input type="text" name="txtEmail" id="txtEmail" id="txtEmail"></td>
		</tr>
		<tr>
			<th> Data do cadastro: </th>
			<td><input type="text" name="dataCad" class="calendario" /></td>
		</tr>
		<tr>
